...
const basicAuthenticationHandler = async (request, event, config = {
  ...
  if (!debug && protocol !== 'https:' || request.headers.get('x-forwarded-proto') !== 'https') {
...
const createKVCredentialsVerifier = KV_NAMESPACE => {
